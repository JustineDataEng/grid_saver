...
def load_data():
    ...
    df['grid_stress_event'] = df['stress_score'] >= stress_threshold
    ...
    <div style='display: flex; justify-content: space-between; align-items: center;'>
        <div>
            ...
            <p style='color: #888; margin: 5px 0 0 0; font-size: 0.9rem;'>
                Texas ERCOT 2025 | Full SPA Integration | Red Bull Basement 2026
            </p>
        </div>
...
vulnerable_pct = df_view['grid_stress_event'].mean() * 100
vulnerable_hours = int(df_view['grid_stress_event'].sum())
...
<div style='background: #161B22; padding: 15px; border-radius: 8px;
    ...
    <p style='color: #555; margin: 5px 0 0 0; font-size: 0.75rem;'>
        ...
        Full SPA integration complete across Phase 1, 2 and 3
    </p>
</div>
""", unsafe_allow_html=True)
