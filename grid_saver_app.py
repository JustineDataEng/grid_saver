...
# Real demand forecasting will be implemented in Month 2
# using PJM load datasets.
# ============================================================
@st.cache_data
def load_data():
    df = pd.read_csv('snapshots_2026-02-10_US-TEX-ERCO-2025-hourly.csv')
...
with st.sidebar.expander("Dataset Information"):
    ...
    **Note:** Demand simulated from carbon intensity.
    Real forecasting added in Month 2 via PJM datasets.
    """)
...
arch = [
    (col_a, "👁️", "SENSE", "#1B4F8C", "#4A9EFF",
     ...
     "✅ ACTIVE - Month 1 Complete", "#2ECC71"),
...
<div style='background: #161B22; padding: 15px; border-radius: 8px;
    ...
    <p style='color: #555; margin: 5px 0 0 0; font-size: 0.75rem;'>
        ...
        Real forecasting via PJM datasets in Month 2
    </p>
</div>
""", unsafe_allow_html=True)
